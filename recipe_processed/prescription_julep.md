...
| ------------: | -------------------------------------------------------- | --------------------- |
|        <span class="onex active">1 <sup>1</sup>&frasl;<sub>2</sub> oz  / 45 ml</span> <span class="onehalfx">2 <sup>1</sup>&frasl;<sub>4</sub> oz  / 68 ml</span> <span class="twox">3 oz  / 90 ml</span> <span class="threex">4 <sup>1</sup>&frasl;<sub>2</sub> oz  / 135 ml</span>| Cognac [&#9432;](/spirit/cognac/ "More Cognac recipes")                                                   | Maison Rouge V.S.O.P. |
...
<script type="application/ld+json">
{
  ...
  "image": "{{ site.url }}/assets/images/category_julep.png",
