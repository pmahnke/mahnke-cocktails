...
| -----: | --------------------------------------------------------- | ----------------------- |
|  <span class="onex active">1 <sup>2</sup>&frasl;<sub>3</sub> oz / 50 ml</span> <span class="onehalfx">2 <sup>1</sup>&frasl;<sub>2</sub> oz / 75 ml</span> <span class="twox">3 <sup>1</sup>&frasl;<sub>3</sub> oz / 100 ml</span> <span class="threex">5 oz / 150 ml</span>| London Dry Gin [&#9432;](/spirit/london_dry_gin/ "More London Dry Gin recipes")                                            | The Botanist            |
...
<script type="application/ld+json">
{
  ...
  "image": "{{ site.url }}/assets/images/cocktail_cloud_sour_dynamic.png",
