...
color: #d6d842
stars: 3.5
base_spirits: ['Green Chartreuse', 'London Dry Gin']
...
date: 2025-08-11
image: /assets/images/cocktail_three_shades_of_green_dynamic.svg
glass: coupe
garnishes: garnish_cucumber
type: shaken
---
...
| -------: | --------------------------------------------------------- | ---------------- |
|   <span class="onex active">1 <sup>1</sup>&frasl;<sub>2</sub> oz  / 45 ml</span> <span class="onehalfx">2 <sup>1</sup>&frasl;<sub>4</sub> oz  / 68 ml</span> <span class="twox">3 oz  / 90 ml</span> <span class="threex">4 <sup>1</sup>&frasl;<sub>2</sub> oz  / 135 ml</span>| London Dry Gin [&#9432;](/spirit/london_dry_gin/ "More London Dry Gin recipes")                                                       |
...
<script type="application/ld+json">
{
  ...
  "image": "{{ site.url }}/assets/images/cocktail_three_shades_of_green_dynamic.png",
