...
color: #E57C01
image: /assets/images/cocktail_3_dots_dash.svg
stars: "0"
base_spirits: "Rhum Agricole, Demerara Rum, Allspice Dram"
youtube: "CGkWnYhu4ag"
description: |
  The Three Dots and a Dash is a classic tiki cocktail created by Donn Beach during World War II, with a name that means "Victory" in Morse code. It's a complex and tasty rum drink, balanced by tropical fruit and honey.
excerpt: |
...
- Glassware: 
  - High Ball
  - Crushed Ice
- Garnish: 3 cherries with a pineapple spear (Morse code for 'V'ictory) on a long stick and a straw
- Special Prep: None
