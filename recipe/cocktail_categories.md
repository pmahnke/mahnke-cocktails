...
- Created: 1930s
- Example: [Bramble]({%link recipe/bramble.md%})
...
- Created: Pre-1922
- Example: [Piña Colada]({%link recipe/pina_colada.md%})
...
- Created: London 1814
- Example: [Tom Collins]({%link recipe/tom_collins.md%})
...
- Example: [Brandy Crusta]({%link recipe/brandy_crusta.md%})
...
- Created: Mid 1800s
- Example: [Pimm's Cup]({%link recipe/pimms_cup.md%})
...
- Example: [Margarita]({%link recipe/margarita.md%})
- Created: Pre-1876
...
- Created: 1600s
- Example: [Eggnog]({%link recipe/eggnog.md%})
...
- Example: [Sherry Flip]({%link recipe/sherry_flip.md%})
...
- Created: 1800s
- Example: [Absinthe Frappé]({%link recipe/absinthe_frappe.md%})
...
- Example: [Frozen Strawberry Margarita]({%link recipe/margarita_strawberry.md%})
...
- Example: [Mint Julep]({%link recipe/mint_julep.md%})
...
- Example: [Martini]({%link recipe/martini.md%})
...
- Created: 1990s
- Example: [Espresso Martini]({%link recipe/espresso_martini.md%})
...
- Example: [Fish House Punch]({%link recipe/philly_fish_house_punch.md%})
...
- Example: [Gin Rickey]({%link recipe/gin_rickey.md%})
...
- Example: [Harvey_wallbanger]({%link recipe/harvey_wallbanger.md%})
...
- Example: [Strawberry Basil Smash]({%link recipe/strawberry_basil_smash.md%})
...
- Example: [Whiskey Sour]({%link recipe/whiskey_sour.md%})
...
- Example: [Chartreuse Swizzle]({%link recipe/chartreuse_swizzle.md%})
...
- Example: [Long Island Iced Tea]({%link recipe/long_island_iced_tea.md%})
